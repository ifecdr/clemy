...
namespace XamlBindingInfo
{
    ...
    internal:
        ...
        virtual void VectorChanged_Object(::Windows::Foundation::Collections::IObservableVector<::Platform::Object^>^ sender, ::Windows::Foundation::Collections::IVectorChangedEventArgs^ e)
        {
            if (this->_pBindingsTrackingWeakRef)
            {
        ...
        void UpdateVectorChangedListener_Object(::Windows::Foundation::Collections::IObservableVector<::Platform::Object^>^ obj, ::Windows::Foundation::Collections::IObservableVector<::Platform::Object^>^* pCache, ::Windows::Foundation::EventRegistrationToken* pToken)
        {
            if (*pCache != nullptr && !(*pCache)->Equals(obj))
            {
            ...
            {
                *pCache = obj;
                *pToken = obj->VectorChanged += ref new ::Windows::Foundation::Collections::VectorChangedEventHandler<::Platform::Object^>(
                    this, &::XamlBindingInfo::XamlBindingTracking::VectorChanged_Object);
            }
        }
