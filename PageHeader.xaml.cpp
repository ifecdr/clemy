...
namespace ClemyAcademyApp
{
	namespace Controls
	{
		...
		PageHeader::PageHeader()
		{
			...
			PageHeader::Loaded += ref new Windows::UI::Xaml::RoutedEventHandler(this, &ClemyAcademyApp::Controls::PageHeader::OnLoaded);
			PageHeader::Unloaded += ref new Windows::UI::Xaml::RoutedEventHandler(this, &ClemyAcademyApp::Controls::PageHeader::OnUnloaded);
		}
